/**
 * AllocationGateway Orchestrator & Router
 */
...
class AllocationGateway {
  constructor(providers = {}) {
    this.providers = {
      SIMULATION: providers.simulationProvider || new SimulationProvider(),
      EXTERNAL: providers.externalProvider || new ExternalProvider()
    };
  }
